...
import com.fadlurahmanfdev.kotlin_feature_crypto.base.BaseKeyPairCryptoVault
...
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.rsa.CryptoVaultRSAEncryptionPadding
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.rsa.CryptoVaultRSAEncryptionPadding.*
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.rsa.CryptoVaultRSASignaturePadding
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.rsa.CryptoVaultRSASignaturePadding.*
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.rsa.CryptoVaultRSATransformationMode
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.rsa.CryptoVaultRSATransformationPadding
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.CryptoVaultSignatureAlgorithm
import com.fadlurahmanfdev.kotlin_feature_crypto.enums.rsa.CryptoVaultRSASignatureAlgorithm
...
class CryptoVaultRSA : BaseKeyPairCryptoVault() {
    ...
    fun verifySignature(
        ...
        return try {
            ...
            val publicKey = KeyFactory.getInstance(CryptoVaultAlgorithm.RSA.name)
    ...
    fun decrypt(
        ...
        val privateKeySpec = PKCS8EncodedKeySpec(decode(encodedPrivateKey))
        val privateKey =
            KeyFactory.getInstance(CryptoVaultAlgorithm.RSA.name).generatePrivate(privateKeySpec)
        cipher.init(Cipher.DECRYPT_MODE, privateKey)
        return String(cipher.doFinal(decode(encryptedText)))
    }
}