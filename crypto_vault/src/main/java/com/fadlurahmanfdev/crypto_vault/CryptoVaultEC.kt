...
import com.fadlurahmanfdev.crypto_vault.base.BaseKeyPairSigningCryptoVault
...
class CryptoVaultEC : BaseKeyPairSigningCryptoVault() {
    private val algorithm = com.fadlurahmanfdev.crypto_vault.enums.CryptoVaultAlgorithm.EC
    ...
    fun generateSignature(
        ...
        plainText: String,
        signatureAlgorithm: com.fadlurahmanfdev.crypto_vault.enums.ec.CryptoVaultECSignatureAlgorithm,
    ...
    fun encrypt(
        encodedPublicKey: String,
        transformation: com.fadlurahmanfdev.crypto_vault.enums.ec.CryptoVaultECTransformation,
        plainText: String,
    ): String {
        ...
        val publicKey =
            KeyFactory.getInstance(com.fadlurahmanfdev.crypto_vault.enums.CryptoVaultAlgorithm.EC.name).generatePublic(publicKeySpec)
    ...
    fun generateSharedSecret(
        ...
        val privateKey = KeyFactory.getInstance(com.fadlurahmanfdev.crypto_vault.enums.CryptoVaultAlgorithm.EC.name)
            .generatePrivate(privateKeySpec)
        val otherPublicKeySpec = X509EncodedKeySpec(decode(otherEncodedPublicKey))
        val otherPublicKey =
            KeyFactory.getInstance(com.fadlurahmanfdev.crypto_vault.enums.CryptoVaultAlgorithm.EC.name)
